...
const isPureObject = (obj: unknown): obj is Record<string, any> => obj !== null && !Array.isArray(obj) && typeof obj === 'object'

function ensureItemIsLast(item: string) {
  return (arr: string[]) => {
...
export function getPostcssConfig(nuxt: Nuxt) {
